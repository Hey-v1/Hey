                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-2">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="recommended_courses[]" value="<?php echo $course['id']; ?>" id="course_<?php echo $course['id']; ?>" <?php echo in_array($course['id'], $recommended_courses ?? []) ? 'checked' : ''; ?>>
